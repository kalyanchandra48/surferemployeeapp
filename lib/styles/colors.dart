...
class AppColors {
  static Color appthemeColor = const Color(0xff1849D8);
  static Color bottomNavColor = const Color(0xffFFFFFF).withOpacity(0.2);
  static Color progressBarColor = const Color(0xffF47674);
}
...
class ContainerColors {
  ...
  static Color redShade = const Color(0xffF57D7B);
  static Color redShadelight = const Color(0xffF8ABAA);
  static Color bluelight = const Color(0xffDCF3FE);
  static Color surfblue = const Color(0xff54B5F7);
...
class DividerColors {
  static Color primaryGrey = const Color(0xff343434).withOpacity(0.2);
  static Color takenLeavesBlue = const Color(0xff54B5F7).withOpacity(0.3);
  static Color holidayGolden = const Color(0xffEED682).withOpacity(0.9);
}
...
class RequestStatusBgColor {
  static Color approved = const Color(0xff38E79B);
  static Color denied = const Color(0xffF15350);
  static Color cancelled = const Color(0xffD0D0D0);
  static Color pending = const Color(0xffFB7034).withOpacity(0.1);
  static Color moreinfo = const Color(0xffEFD274).withOpacity(0.2);
}

// IT Request Status Text Color
class RequestStatusTextColor {
  static Color approved = const Color(0xffFFFFFF);
  static Color denied = const Color(0xffFFFFFF);
  static Color cancelled = const Color(0xffFFFFFF);
  static Color pending = const Color(0xffFB7034);
  static Color moreinfo = const Color(0xffEFD274);
}
