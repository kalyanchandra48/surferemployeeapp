...
extension GetItemCollection on Isar {
  IsarCollection<Item> get items {
    return getCollection('Item');
  }
}

final ItemSchema = CollectionSchema(
  name: 'Item',
  schema:
  ...
  nativeAdapter: const _ItemNativeAdapter(),
  webAdapter: const _ItemWebAdapter(),
  idName: 'id',
  propertyIds: {
    'amount': 0,
    'availableQty': 1,
...
class _ItemWebAdapter extends IsarWebTypeAdapter<Item> {
  const _ItemWebAdapter();

  @override
  Object serialize(IsarCollection<Item> collection, Item object) {
  ...
  @override
  Item deserialize(IsarCollection<Item> collection, dynamic jsObj) {
    final object = Item(
  ...
  @override
  void attachLinks(Isar isar, int id, Item object) {}
}

class _ItemNativeAdapter extends IsarNativeTypeAdapter<Item> {
  const _ItemNativeAdapter();

  @override
  void serialize(IsarCollection<Item> collection, IsarRawObject rawObj,
  ...
  @override
  Item deserialize(IsarCollection<Item> collection, int id,
